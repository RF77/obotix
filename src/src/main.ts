...
import { importFilesTexts, intializeApp } from './initApp';
const monacoConfig: NgxMonacoEditorConfig = {

  onMonacoLoad: async () => {
    const monaco = (<any>window).monaco;

    console.debug("onMonacoLoad");
    monaco.languages.typescript.javascriptDefaults.setExtraLibs(importFilesTexts.map(i => ({ content: i, filePath: null })));
